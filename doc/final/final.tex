...
\subsubsection{Performance} We compare the performance of our library against other existing data cleaning works. The total of execution times of each task, including the time for Spark initialization, data loading, and data preprocessing, were all recorded and listed below.
\begin{itemize}
	\item{Scaling and Normalization}: TODO by Charson. The experiment results can be found in table \ref{tab:Scaling and Normalization Experiment Result}.
	\item{Special Character Cleaning}:  TODO by Charson. The results are shown in table \ref{tab:Special Character Cleaning Experiment Result}.
\end{itemize}
...
\begin{itemize}
	...
	\item{Scaling and Normalization}: TODO by Charson. The results are shown in table \ref{tab:Scaling and Normalization - Scalability Experiment Result}.
	\item{Text Cleaner}: TODO by Charson. The results are shown in table \ref{tab:Text Cleaner - Scalability Experiment Result}.
\end{itemize}
