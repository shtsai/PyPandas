...
\begin{itemize}
	...
	\item{Bisecting KMeans}\cite{biKmeans}: This method is very similar to KMeans clustering. The only difference is that it uses the bisecting Kmeans clustering algorithm. The algorithm does not start with k clusters. Instead, it gradually divides clusters and generates k clusters after a number of iterations.
